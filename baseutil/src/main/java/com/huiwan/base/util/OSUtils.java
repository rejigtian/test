...
public class OSUtils {
    ...
    public static boolean isArm64Apk() {
        String nativeLibraryDir = LibBaseUtil.getApplication().getApplicationInfo().nativeLibraryDir;
        Log.i(TAG, "isArm64Apk: " + nativeLibraryDir);
        if (!TextUtils.isEmpty(nativeLibraryDir)) {
            return nativeLibraryDir.endsWith("/lib/arm64");
        }
        return false;
    }
