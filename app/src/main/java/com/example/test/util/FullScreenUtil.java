...
public class FullScreenUtil {
    ...
    public static void setFullScrrenCompatible(Window window) {
        ...
        if (Build.BRAND.equals("xiaomi") && hasXiaoMiNotch(window.getContext())) {
            setXiaoMiFullScreenInDisplayCutout(window);
        }
        if (getHuaWeiBrand().contains(Build.BRAND) && hasXiaoMiNotch(window.getContext())) {
    ...
    private static List<String> getHuaWeiBrand() {
